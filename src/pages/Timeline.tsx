...
const Timeline = () => {
  ...
  const courses = [
    ...
    { code: "CS2101", name: "CS2101 - Algorithms" },
    { code: "CS2202", name: "CS2202 - Computer Organization" },
    { code: "CS3103", name: "CS3103 - Operating Systems" },
    { code: "CS3204", name: "CS3204 - Computer Networks" },
  ];
